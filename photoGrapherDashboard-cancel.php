...
<section id="user-dashboard-page">
            ...
            <?php 
                $bsql = "SELECT * FROM  bookings WHERE photoGrapherEmail='".$_SESSION['email']."' AND status='Cancelled' ORDER BY bookAt DESC";
                    ...
                    <div class="booking-details user-booking-details" style="padding-bottom: 20px">
                        ...
                        <div class="details">
                            ...
                            <div class="bookedPhotographer">
                                ...
                                Status: <span style="color: red;"><?php echo "".$brow['status']; ?></span></p></div>
                            </div>
                        </div>
                    </div>
                    <hr class="user-hr"/><?php }}else{ ?><p class="booking-id user-booking-id" style="font-size: 45px;padding: 50px; text-align: center">No Cancelled Requests</p><?php } ?>
                </div>
            </div>
        </section>
