...
if(isset($_POST["submit"])) {
    ...
    if ($stmt->execute()) {
        if (move_uploaded_file($profile_tmpname, $profile_folder)) {
            echo "<script>alert(\"Upload Successful\"); window.location='photographerCompleteProfile1.php';</script>";
        } else {
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <h1 class="h5 mb-3 fw-normal">Step 1: Upload your Profile Photo</h1>
